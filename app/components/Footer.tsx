...
export default function Footer(){
    ...
    return (
        <footer className='bg-blue md:pb-16 p-5 gap-5 box-border md:p-7 w-full h-fit min-h-[20vh] md:h-[20vh] grid grid-cols-[15%_85%] grid-rows-[fit-content_40%_40%] md:grid-cols-[20%_40%_40%] md:grid-rows-[80%_20%]'>
